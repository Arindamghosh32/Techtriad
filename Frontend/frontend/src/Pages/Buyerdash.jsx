...
<div class="content">
    ...
    <main class="main">
        ...
        <section class="card">
            ...
            <div class="rfq-tabs">
                <button class="rfq-tab active">New RFQ</button>
                <button class="rfq-tab">Quotes Received</button>
                <button class="rfq-tab">Completed RFQ</button>
                <button class="rfq-tab">Closed RFQ</button>
            </div>
            ...
            <button class="add-products-btn">Add Products</button>
        </section>
    </main>
